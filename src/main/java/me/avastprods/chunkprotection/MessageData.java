...
public class MessageData {
	...
	public void setup() {
		...
		if(!getData().contains("message.command.claim_limit_reached")) getData().set("message.other.claim_limit_reached", "&4Error: &cYou have reached the limit of claimed chunks!");
